...
class RatedDocPage extends StatefulWidget {
  final String specialty;
  RatedDocPage(this.specialty);
  @override
  _RatedDocPageState createState() => _RatedDocPageState();
}

class _RatedDocPageState extends State<RatedDocPage> {
